    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Нельзя поставить оценку ниже 1'), django.core.validators.MaxValueValidator(10, message='Нельзя поставить оценку выше 10')], verbose_name='Oценка')),
